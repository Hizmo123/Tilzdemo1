...
// Addition alongside the existing email+password form below it — same
// /auth/callback route, same session cookie once it completes. Doesn't touch
// signIn/signUp at all.
export function GoogleSignInButton() {
  const [state, action] = useActionState(signInWithGoogle, initial);
